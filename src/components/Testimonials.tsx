              ...
              <ul role="list" className="flex flex-col gap-y-6 sm:gap-y-8">
                {column.map((testimonial, testimonialIndex) => (
                  <li key={testimonialIndex}>
                    <figure className="relative rounded-2xl bg-supporting p-6 shadow-xl shadow-primary/10">
                      <QuoteIcon className="absolute top-6 left-6 fill-primary/10" />
                      <blockquote className="relative">
                        <p className="text-lg tracking-tight text-primary">
                          {testimonial.content}
                        </p>
                      </blockquote>
                      <figcaption className="relative mt-6 flex items-center justify-between border-t border-primary/10 pt-6">
                        <div>
                        ...
                        <div className="overflow-hidden rounded-full bg-primary/5">
                          <Image
